...
- Ask for any additional information you require, don't make assumptions.
...
## General dependencies Guidelines

- Always pin the dependencies
- Always search for the latest version when you add a new dependencies.
For example for npm:
```
npm view <package> view
```
